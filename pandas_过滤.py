...
# %%
new_demo = pd.read_csv(
    'E://source_data/after_delete_empty_nulls/new_demo_delete_empty_lines_na-gt-limit_drop_duplicates.csv',
    encoding='utf-8',
    dtype='object',
    engine='c',
...
# %%
drivers = pd.read_csv(
    'E://source_data/after_delete_empty_nulls/drivers_utf-8_delete_empty_nulls_na-gt-limit_drop_duplicates.csv',
    encoding='utf-8',
    dtype='object',
    engine='c',
    error_bad_lines=False)
...
# %%
test.to_csv(
    'E://source_data/after_delete_empty_nulls/drivers_utf-8_delete_empty_nulls_na-gt-limit_drop_duplicates_filter.csv',
    header=True,
    index=False)
