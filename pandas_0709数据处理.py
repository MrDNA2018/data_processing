...
# %%
cases_fraud = pd.read_csv(
    'E://source_data/0709_data/cases_fraud_3.csv',
    encoding='utf-8',
    dtype='object',
    engine='c',
...
insureds.rename(
    columns={
        'insured': 'name',
        'insuredphone': 'phone',
        'insuredidentifynumber': 'identifynumber'},
    inplace=True)
...
thirdpartylinkers.rename(
    columns={
        'thirdpartylinker': 'name',
        'thirdpartylinkerphone': 'phone'},
    inplace=True)
...
# %%
total_guys.to_csv(
    'E://source_data/0709_data/total_guys_3.csv',
    header=True,
    index=False)
# %%
total_guys = pd.read_csv(
    'E://source_data/0709_data/total_guys_3.csv',
    encoding='utf-8',
    dtype='object',
    engine='c',
...
# %%
total_cars.to_csv(
    'E://source_data/0709_data/total_cars_1.csv',
    header=True,
    index=False)
# %%
total_cars = pd.read_csv(
    'E://source_data/0709_data/total_cars_1.csv',
    encoding='utf-8',
    dtype='object',
    engine='c',
